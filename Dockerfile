...
FROM docker.io/stalwartlabs/stalwart:v${STALWART_VERSION}@sha256:9ed1d343243b7aa72969e372a7240b7ddea07730781d4b68a0dc3d8d51c418bb
USER root
RUN apt-get update \
