...
FROM docker.io/stalwartlabs/stalwart:v${STALWART_VERSION}@sha256:a8108e19bd927e172d4d8c128907b8dfc93fd180ae8ee07dccdd42cb97eb9dfa
USER root
RUN apt-get update \
